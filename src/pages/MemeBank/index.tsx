      ...
      <div className="w-full flex flex-col mt-10 text-white ">
        ...
        <div className="flex justify-center items-center mt-6 ">
          <Link
            ...
            target="_blank"
            className="text-white font-soli bg-red-600 text-2xl lg:text-[36px] py-6 px-8 rounded-tl-lg rounded-tr-[20px] rounded-br-[8px] rounded-bl-[20px] "
          >
            MEME BANK
          </Link>
        </div>
        <div className="w-full flex-col mt-20 lg:mt-24">
          ...
          <Link
            ...
            >
            Switch your PFP, Tweet it, and we'll add you to the <span className='text-red-600'>
              ARMY Twitter list
</span>
          </Link>
            </div>
        ...
        <div className="w-full relative ">
          ...
          <div className="absolute top-[20%] z-10">
            <img src={memeFooter} alt="memefooter" className='w-full h-auto' />
          </div>
        </div>
      </div>
    </DashboardLayout>
